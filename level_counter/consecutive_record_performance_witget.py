...
class ConsecutiveRecordPerformanceWidget(QtWidgets.QWidget):
    ...
    def __init__(self, controller, voice_service, event_bus, parent=None):
        ...
        """ 
        # タイトルラベル
        self.title_label = QtWidgets.QLabel("Streak +1!")
        ...
        # 日数ラベル（大きく目立たせる）
        self.days_label = QtWidgets.QLabel("1")
        self.days_label.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        # サブラベル
        self.sub_label = QtWidgets.QLabel("連続日数達成！")
        ...
        """
        self.event_bus.on("level_counter.consecutive_days", self._update_consecutive_days)

    """
    ここに、各種ロジックを記述。
    """

    def _update_consecutive_days(self, days):
        self.open(days["days"])
