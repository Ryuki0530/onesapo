...
class MovieMenuOpenButtonWidget(QtWidgets.QWidget):

    def __init__(self, controller, voice_service, menu: MovieMenuWidget, event_bus, config: ConfigData, parent=None):
        ...
        # 設定画面を開くボタン
        self.open_button = QtWidgets.QPushButton("🎞️")
